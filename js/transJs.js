...
//alert("ahmed");
          $.ajax({
            url: "../php/FichierPhp.php?method=1", //the page containing php script
    ...
    var html="" ,flag=false;
                    ...
                    $.each(this, function(k, value) {
                     if(k!="id" )
                     {
                          ...
                          {
                                html+='<td style=" width: 29%;" contenteditable="true"><input type="text" class="form-control" value="'+value+'" /></td>';
                          }      
                     }
                    });  html+="</tr>";
                    $('#row').html(html); 
